...
(() => {
    ...
    const I18N = /* pasted as-is from your file */ {
        vi: {
            ...
            "family.inviteLine": "Thân mời đến dự lễ vu quy của chúng tôi!",
            ...
            "story.y2022.text":
                "Chúng mình hai con người, ở hai quốc gia khác nhau, tưởng chừng sẽ không thể hòa hợp. Tình yêu đối với chúng mình lúc đó không chỉ là sự thấu hiểu giữa hai tính cách nữa, mà còn là sự khác biệt về ngôn ngữ, văn hóa. Đó là rào cản đầu tiên khi chúng mình bắt đầu tìm hiểu về đối phương. Cả hai mang trong mình những hoài bão khác biệt, một tương lai mà cả hai chưa bao giờ nghĩ sẽ gặp gỡ và đồng hành cùng nhau. Một thành phố nhỏ và bình yên nằm ở phía Bắc nước Úc nơi chúng mình lần đầu gặp nhau và quyết định nắm tay đi tiếp chặng đường còn lại.",
            ...
            "dress.title": "QUY ĐỊNH TRANG PHỤC",
            ...
            "rsvp.companionsPh": "Bạn đi cùng ai? (tuỳ chọn)",
            "rsvp.companionsAria": "Nhập tên người đi cùng",
        ...
        en: {
            ...
            "saveDate.date": "DATE",
            "usNow.title": "Us now",
            "usNow.subtitle": "A new chapter in our life.",
            ...
            "rsvp.companionsPh": "Who are you going with? (optional)",
            "rsvp.companionsAria": "Enter companion name(s)",
    ...
    const serializeRSVP = () => ({
        ...
        companions: (els.rsvpCompanions?.value || "").trim(),
